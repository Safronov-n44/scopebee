...
(function () {
  var add = {
    en: {
      ...
      'acandy.card.text': 'A Flash game from more than 14 years ago, rebuilt with sound, streamed music, physics, tags and animation.',
      ...
      'acandy.p2': 'A finished game leans on much of the engine at once:',
      'acandy.f1': 'Sound effects.',
      'acandy.f2': 'Streamed music — the track plays as it arrives instead of being loaded whole before the game starts.',
      'acandy.f3': '2D physics — rigid bodies, colliders and physics materials.',
      'acandy.f4': 'Tags — objects are marked by what they are: a glass plank carries the Glass tag.',
      'acandy.f5': 'Animated objects — state machines in the Animator; a glass plank has an Idle and a Break state.',
      'acandy.f6': 'The UI layer — the main menu, level select and settings.',
      ...
      'acandy.w.disk': 'Build size',
      'acandy.w.res': 'Unpacked',
      'acandy.w.first': 'First frame',
      'acandy.w.heap': 'Heap snapshot',
      'acandy.w.note': 'Build size is every file of the build on disk, shipped already packed with Brotli; Unpacked is the same files decompressed. First frame is the line the build prints when its first frame is drawn, median of three cold loads served locally, so the download does not count towards it. Heap snapshot is a Chrome heap snapshot on the idle main menu. Mac mini M2, 16 GB, Chrome 153.',
      'acandy.h4': 'Try it',
    ...
    ru: {
      ...
      'acandy.card.text': 'Flash-игра больше чем 14-летней давности, пересобранная со звуком, стримингом музыки, физикой, тегами и анимацией.',
      ...
      'acandy.p2': 'Законченная игра задействует сразу многое из движка:',
      'acandy.f1': 'Звуковые эффекты.',
      'acandy.f2': 'Стриминг музыки — трек играет по мере загрузки, а не скачивается целиком до старта игры.',
      'acandy.f3': '2D-физика — твёрдые тела, коллайдеры и физические материалы.',
      'acandy.f4': 'Теги — объекты помечены тем, чем они являются: у стеклянной планки тег Glass.',
      'acandy.f5': 'Анимация объектов — машины состояний в Аниматоре; у стеклянной планки есть состояния Idle и Break.',
      'acandy.f6': 'Слой UI — главное меню, выбор уровня и настройки.',
      ...
      'acandy.w.disk': 'Размер сборки',
      'acandy.w.res': 'В распакованном виде',
      'acandy.w.first': 'Первый кадр',
      'acandy.w.heap': 'Heap Snapshot',
      'acandy.w.note': 'Размер сборки — все файлы сборки на диске, которые уже поставляются сжатыми Brotli; в распакованном виде — те же файлы после распаковки. Первый кадр — строка, которую сборка печатает при отрисовке первого кадра, медиана трёх холодных загрузок с локального сервера, чтобы в него не входило скачивание. Heap Snapshot — снимок кучи Chrome на простаивающем главном меню. Mac mini M2, 16 GB, Chrome 153.',
