...
(function () {
  ...
  var I18N = {
    en: {
      ...
      'compare.lead': 'The same projects built with different engines. Bar length is the share of the heaviest result in that column.',
    ...
    ru: {
      ...
      'compare.lead': 'Одинаковые проекты, собранные разными движками. Длина полосы — доля от самого тяжёлого результата в колонке.',
